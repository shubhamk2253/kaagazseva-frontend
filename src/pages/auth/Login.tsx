    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <div className="bg-white rounded-[32px] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100 relative overflow-hidden">
        ...
        <div className="mb-10 text-center">
          ...
          <h2 className="text-3xl font-[950] text-slate-900 tracking-tight">Enter Mobile</h2>
          <p className="text-slate-500 mt-2 font-medium">We'll send a 6-digit secure code</p>
        </div>
        ...
        <form onSubmit={handleSendOTP} className="space-y-8">
          ...
          <div className="space-y-3">
            ...
            <div className={`
              ...
              ${mobile.length > 0 ? (isFormValid ? 'border-blue-600 bg-blue-50/10' : 'border-red-200 bg-red-50/10') : 'border-slate-100 bg-slate-50/50'}
      ...
      <p className="mt-8 text-center text-[10px] text-slate-400 font-bold leading-relaxed uppercase tracking-tighter">
        ...
        <span className="text-slate-900 cursor-pointer hover:text-blue-600 transition-colors">Terms of Service</span> & <span className="text-slate-900 cursor-pointer hover:text-blue-600 transition-colors">Privacy Policy</span>
      </p>
    </div>
  );
};
