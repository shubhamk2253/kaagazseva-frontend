...
export const AdminDashboard: React.FC = () => {
  const {
    data: stats,
    request: fetchStats,
  } = useApi<SystemStats, []>(adminService.getDashboardStats);

  const {
    data: chartData,
    request: fetchChart,
  } = useApi<RevenueData[], [number]>(adminService.getRevenueData);
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-blue-600 text-white border-none shadow-xl">
          <p className="text-xs uppercase tracking-widest">Total GMV</p>
